  ...
  return (
    <div className="about-section">
      <p>
        ...
        applications using technologies like Next.js, React.js, Node.js, and
        MongoDB. I specialize in delivering efficient end-to-end solutions,
        optimizing performance, and mentoring junior developers.
      </p>
      <br />
      <p>
        Passionate about clean code and continuous learning, I’ve contributed to
        e-commerce and e-learning platforms, integrating tools like Docker,
        RabbitMQ, and Razorpay. Currently exploring Kafka and microservices, I
        strive to build robust, high-performing systems.
      </p>
      <br />
      ...
      <ul className="list-disc mt-4">
        <li >
          <a
            href="https://connecto-xi.vercel.app/"
            target="_blank"
        ...
        <li >
          <a
            href="https://dev-tinder-f.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-600 hover:cursor-pointer"
          >
        ...
        <li >
          <a
            href="https://docsync-chi.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-600 hover:cursor-pointer"
          >
        ...
        <li >
          <a
            href="https://subhash1107.github.io/simongame/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-yellow-600 hover:cursor-pointer"
          >
